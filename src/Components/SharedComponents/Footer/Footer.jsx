...
import logo2 from '../../../assets/arLogo.png'
        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
                <img className="w-10 text-white" src={logo2} alt="" />
              </div>
              <span className="font-poppins text-white self-center text-2xl font-semibold">
                Ashikur Riyal
              </span>
            </a>
          </div>
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3">
              <h3 className="tracking-wide text-lg font-poppins text-customOrange font-semibold dark:text-gray-900">
                Navigation
              </h3>
              <ul className="space-y-1">
                <li>
                  <a className="font-poppins text-white font-normal text-sm" rel="noopener noreferrer" href="#">
                    Home
                  </a>
                </li>
              </ul>
            ...
            <div className="space-y-3">
              <div className="tracking-wide text-lg font-poppins text-customOrange font-semibold dark:text-gray-900">Social media</div>
              <div className="flex justify-start space-x-3">
                ...
                <a
                  ...
                  href="#"
                  title="Twitter"
                  className="flex text-white items-center p-1"
                >
                  <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
